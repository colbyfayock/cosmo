...
export async function getWeather(lat = 40.02, lon = -75.64): Promise<WeatherResult> {
  ...
  try {
    ...
    console.error('Open-Meteo failed, falling back to wttr.in...', (err as Error).message);
  }
